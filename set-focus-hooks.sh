...
tmux set-hook -g client-focus-in "\
  ...
  set -g status-right \"#[fg=colour06]#(~/.tmux/plugins/base16-tmux-powerline/truncate_path.sh #{pane_current_path} 40) #[fg=colour20,bg=default]#[fg=colour15,bg=colour20] %H:%M:%S #[fg=colour19,bg=colour20]#[fg=colour21,bg=colour19] %d-%b-%y #[fg=colour06,bg=colour19]#[fg=colour18,bg=colour06,bold] #H \" ; \
...
tmux set-hook -g client-focus-out "\
  ...
  set -g status-right \"#[fg=colour19]#(~/.tmux/plugins/base16-tmux-powerline/truncate_path.sh #{pane_current_path} 40) #[fg=colour18,bg=default]#[fg=colour19,bg=colour18] %H:%M:%S #[fg=colour18,bg=colour18]#[fg=colour19,bg=colour18] %d-%b-%y #[fg=colour18,bg=colour18]#[fg=colour18,bg=colour19,bold] #H \" ; \
